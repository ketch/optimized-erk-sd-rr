...
def main(argv):
    ...
    files = ['lin_euler_2d_mid_point.txt','lin_euler_2d_optimal_erk-3-2.txt','lin_euler_2d_optimal_erk-8-2.txt','lin_euler_2d_heun3.txt','lin_euler_2d_optimal_erk-5-3.txt','lin_euler_2d_optimal_erk-17-3.txt','lin_euler_2d_kutta44.txt','lin_euler_2d_optimal_erk-9-4.txt','lin_euler_2d_optimal_erk-18-4.txt','lin_euler_2d_fehlberg.txt','lin_euler_2d_optimal_erk-10-5.txt','lin_euler_2d_optimal_erk-20-5.txt']
    ...
    plt.savefig("../../figures/acoustic_pulse/error-cpu.pdf")
    ...
    for label, x, y in zip(lab_large[1:4],ind[1:4]+width*2.4+0.55, cpu_large[1:4]):
        ax1.annotate(
        label, 
        xy = (x, y), xytext = (5, 10),
        textcoords = 'offset points', ha = 'left', va = 'bottom',
    ...
    ax1.annotate(
    lab_large[0], 
    xy = (ind[0]+width*2+0.55, cpu_large[0]), xytext = (5, 10),
    textcoords = 'offset points', ha = 'left', va = 'bottom',
    bbox = dict(boxstyle = 'round,pad=0.2', fc = 'white', alpha = 0.5),fontsize=18)

    #ax1.annotate(
    #lab_large[3], 
    #xy = (ind[3]+width*2+0.55, cpu_large[3]), xytext = (5, 10),
    #textcoords = 'offset points', ha = 'left', va = 'bottom',
    #bbox = dict(boxstyle = 'round,pad=0.2', fc = 'white', alpha = 0.5),fontsize=15)
    ...
    plt.savefig("../../figures/acoustic_pulse/cpu.pdf")
