#from performance import read_file
...
def main(argv):
    ...
    files = ['lin_adv_2d_mid_point.txt','lin_adv_2d_optimal_erk-3-2.txt','lin_adv_2d_optimal_erk-8-2.txt','lin_adv_2d_heun3.txt','lin_adv_2d_optimal_erk-5-3.txt','lin_adv_2d_optimal_erk-17-3.txt','lin_adv_2d_kutta44.txt','lin_adv_2d_optimal_erk-9-4.txt','lin_adv_2d_optimal_erk-18-4.txt','lin_adv_2d_fehlberg.txt','lin_adv_2d_optimal_erk-10-5.txt','lin_adv_2d_optimal_erk-20-5.txt']
    ...
    for order, filename, stage, style in zip(orders,files, stages, styles):
        cfl, dt, this_err, L2, this_cpu = read_file(order,filename,stage)
    ...
    plt.savefig("../../figures/annulus/error-cpu.pdf")
    ...
    plt.savefig("../../figures/annulus/cpu.pdf")
